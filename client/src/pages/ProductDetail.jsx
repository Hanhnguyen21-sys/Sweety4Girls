    ...
    <section className="min-h-screen bg-cream px-6 py-10">
      <div className="mx-auto grid max-w-5xl items-start gap-10 md:grid-cols-2">
        ...
        <div className="flex flex-col justify-center">
          ...
          <h1 className="mt-2 text-3xl font-bold text-dark">{product.name}</h1>
          ...
          <div className="mt-8 rounded-2xl bg-white p-5 shadow-sm">
            ...
            <div className="space-y-2 text-sm text-neutral">
              ...
              <p>
                <span className="font-semibold text-dark">Materials:</span>{" "}
                {product.details?.materials}
              </p>

              <p>
                <span className="font-semibold text-dark">Care:</span>{" "}
