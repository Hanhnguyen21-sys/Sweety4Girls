...
function About() {
  ...
  return (
    ...
    >
      {/* HEADER */}
      <section className="animate-fadeIn bg-[#EADAD4] px-6 py-16 text-center text-dark">
      ...
      {/* ABOUT CONTENT */}
      <section className="animate-fadeUp mx-auto max-w-6xl px-6 py-16">
        <h2 className="text-3xl font-bold text-accent">Hi there 👋</h2>

        <div className="mt-8 space-y-6 text-lg leading-8 text-neutral opacity-90">
          <p>
          ...
          <p>
            ...
            warm colors, and a happy vibe. We focus on every design, lovely
          ...
          <p>
            Our shop follows the quote: “Best quality – Warm support –
            Wholehearted service.” This is how we work and how we care for every
            customer.
          </p>
        </div>
      </section>
      ...
      {/* CONTACT SECTION */}
      <section className="animate-fadeUpSlow bg-white px-6 py-16">
        <div className="mx-auto grid max-w-5xl overflow-hidden rounded-[2rem] shadow-xl transition-all duration-500 hover:shadow-2xl md:grid-cols-2">
          {/* IMAGE */}
          <div className="h-[500px] overflow-hidden bg-soft md:h-[620px]">
            <img
              src="/images/pink.JPG"
              alt="Crochet flowers"
          ...
          <div className="flex flex-col justify-center bg-cream p-8 md:p-10">
            ...
            <div className="mt-10">
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    className="mt-2 w-full border border-neutral bg-white px-4 py-3 outline-none transition-all duration-300 focus:border-accent focus:ring-2 focus:ring-[#EADAD4]"
                  />
                </div>
              ...
              <button
                ...
                className="mt-5 w-full rounded-full bg-[#EADAD4] py-4 text-sm font-semibold uppercase tracking-[0.25em] text-dark transition-all duration-300 hover:-translate-y-1 hover:bg-accent hover:text-white hover:shadow-xl active:scale-95 disabled:opacity-50"
              >
                Send Message
              </button>
            </div>
